...
- Within =isearch=, ~<C-return>~ opens the currently selected matching heading in
  the base buffer
...
- org-tree-view/levels :: how many levels of heading to show.
- org-tree-view/width :: the width of the tree view.
- org-tree-view/split :: at what side of the base buffer the tree view should be
     opened.
