...
*Update:* As you can see in the [[#ivy][next section]], I am currently trying out Ivy
instead of Helm. Thus, the code below is /not/ tangled to my =custom.el= and not
loaded by Emacs. I will keep it here, though, in case I want to return to Helm
in the future.
