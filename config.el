...
(use-package aggressive-indent
  :demand
  :init
  (defun my/enable-aggressive-indent-mode ()
    (aggressive-indent-mode))
  (add-hook 'emacs-lisp-mode-hook       #'my/enable-aggressive-indent-mode)
  (add-hook 'ielm-mode-hook             #'my/enable-aggressive-indent-mode)
  (add-hook 'lisp-mode-hook             #'my/enable-aggressive-indent-mode)
  (add-hook 'lisp-interaction-mode-hook #'my/enable-aggressive-indent-mode)
  (add-hook 'scheme-mode-hook           #'my/enable-aggressive-indent-mode)
  (add-hook 'racket-mode-hook           #'my/enable-aggressive-indent-mode)
  (add-hook 'eval-expression-minibuffer-setup-hook #'my/enable-aggressive-indent-mode))
